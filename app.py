...
DOCUMENT_PATHS = [
        r"CONVENTIONS-AGAINST-ILLICIT-TRAFFIC-IN-NARCOTIC-DRUGS-AND-PSYCHOTROPIC-SUBSTANCES-ACT-NO-1-OF-200.pdf",
        r"1-company-law-part-1-3-11-2019-notes.pdf",
        r"2-company-law-part-2-24-11-2019-notes.pdf",
        r"3-company-law-part-3-1-12-2019-notes.pdf",
        r"corporate-law.pdf"
...
"""    @app.route("/summarization", methods=['GET', 'POST'])
    ...
    #########################################################################################################
    # Your app configuration and routes here
